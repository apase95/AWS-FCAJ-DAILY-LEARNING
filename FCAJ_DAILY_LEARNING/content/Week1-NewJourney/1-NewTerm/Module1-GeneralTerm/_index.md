...
- **Region (R)**: 1 Region consists of 3 or more AZs. Regions are connected to each other via the backbone network. Data and services between Regions are isolated from each other.
